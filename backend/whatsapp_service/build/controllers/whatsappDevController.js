...
class WhatsappDevController {
    updateUserConversation = async (userId, localChats) => {
        try {
    ...
    checkForExcessiveMessages = (chats) => {
        try {
    ...
    handleWhatsappMessage = async (message) => {
        try {
            ...
            if (isUserAuthorized) {
                ...
                const updatedChats = await this.updateUserConversation(user._id, localChats);
...
exports.default = new WhatsappDevController();
